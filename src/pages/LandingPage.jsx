        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Como cliente de Fortex, tienes acceso a un sistema diseñado específicamente 
              para hacer más eficiente tu experiencia de reclamos
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Desde el llenado del formulario hasta el envío a tu aseguradora, 
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8">
              Nuestro equipo de especialistas está disponible para apoyarte 
              durante todo el proceso de tu reclamo
            </p>
...
const WhatsAppWidget = () => {
  ...
  const [whatsappNumber, setWhatsappNumber] = React.useState('+528122095020'); // Número por defecto

  // En una implementación real, este número vendría del panel de admin
  // Por ahora usamos un número fijo que puede ser configurado
